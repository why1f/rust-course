...
[profile.<name>]         # profile 配置，详情见"如何在 Cargo.toml 中配置 profile" : https://beatai.org/rust-course/cargo/reference/profiles#profile设置
opt-level = 0
debug = true
split-debuginfo = '...'
...
[registries.<name>]  # 设置其它的注册服务： https://beatai.org/rust-course/cargo/reference/specify-deps#从其它注册服务引入依赖包
index = "…"          # 注册服务索引列表的 URL
