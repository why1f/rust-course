...
- [license 或 license-file](https://beatai.org/rust-course/cargo/reference/manifest#license和license-file)
- [description](https://beatai.org/rust-course/cargo/reference/manifest#description)
- [homepage](https://beatai.org/rust-course/cargo/reference/manifest#homepage)
- [documentation](https://beatai.org/rust-course/cargo/reference/manifest#documentation)
- [repository](https://beatai.org/rust-course/cargo/reference/manifest#repository)
- [readme](https://beatai.org/rust-course/cargo/reference/manifest#readme)

你还可以设置[关键字](https://beatai.org/rust-course/cargo/reference/manifest#keywords)和[类别](https://beatai.org/rust-course/cargo/reference/manifest#categories)等元信息，让包更容易被其他人搜索发现，虽然它们不是必须的。

如果你发布的是一个依赖库，那么你可能需要遵循相关的[命名规范](https://beatai.org/rust-course/practice/naming)和 [API Guidlines](https://rust-lang.github.io/api-guidelines/).
...
当打包时，Cargo 会自动根据版本控制系统的配置来忽略指定的文件，例如 `.gitignore`。除此之外，你还可以通过 [`exclude`](https://beatai.org/rust-course/cargo/reference/manifest#exclude和include) 来排除指定的文件:
...
为了实现这一点，只需修改 `Cargo.toml` 中的 [`version`](https://beatai.org/rust-course/cargo/reference/manifest#version) 字段 ，但需要注意：**版本号需要遵循 `semver` 规则**。
